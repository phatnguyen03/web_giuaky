    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
        if($_REQUEST['frm']=='delete'){
            $blog_subscribe->s_sub_id = $_REQUEST['id'];
            if($blog_subscribe->delete()){
                $status = "Delete contact successfully!";
            }
        }
    }
    $stmt = $blog_subscribe->read_all();
?>
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:25%"><?php echo $row['s_sub_email'] ?></td>
                                                    <td style="width:25%"><?php echo $row['s_sub_status'] ?></td>
                                                    <td style="width:25%"><?php echo $row['s_date_created'] ?></td>
                                                    <td style="width:20%"><!-- <a href="edit_blog.php?blog_id="" class="btn btn-warning btn-sm"><i class="fa-solid fa-pencil"></i>Edit</a> -->
                                                    <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="<?php echo '#modal_delete'.$row['s_sub_id'] ?>"><i class="fa-solid fa-trash"></i>Delete</button>
                                                </td>
                                            </tr>
                                            
                                            <!-- Modal delete -->
                                                <div class="modal fade" id="<?php echo 'modal_delete'.$row['s_sub_id'] ?>">
                                                        ...
                                                        <div class="modal-content">
                                                            <form role="form" name="frm_category_delete" method="post" action="<?php echo $_SERVER['PHP_SELF']?>">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <input type="hidden" name="id" value="<?php echo $row['s_sub_id'] ?>">
