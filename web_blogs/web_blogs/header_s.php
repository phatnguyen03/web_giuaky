<header class="s-header s-header--opaque">
    ...
    <div class="s-header__logo">
        <a style="text-decoration: none;font-weight: bold; color: #ffff;margin-top: 10px;" class="logo" href="index.php">
                ...
                <li class="has-children">
                    ...
                    <ul class="sub-menu">
                        ...
                        while($row=$stmt_cate->fetch()){
                            echo "<li><a href='category.php?cate=".$row['category_id']."'>".$row['category_name']."</a></li>"; 
                        }
                        ?>                       
